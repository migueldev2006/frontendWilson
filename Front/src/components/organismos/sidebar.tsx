...
const menuItems = [
  ...
  { name: "Solicitudes", icon: EnvelopeIcon, href: "/solicitudes" },
  {
    ...
    children: [
      ...
      { name: "Tipo Movimientos", icon: ArrowPathRoundedSquareIcon, href: "/reportes/tipos" },
      { name: "Unidades Medida", icon: StopIcon, href: "/reportes/unidades" },
      { name: "Categorias", icon: RectangleStackIcon, href: "/reportes/caegorias" },
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Inventario", icon: ClipboardDocumentListIcon, href: "/estadisticas/inventtario" },
